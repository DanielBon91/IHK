...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.geometry(f"{1800}x{900}+{int(axe_x)}+{int(axe_y)}")  # 1500x1200
        ...
        self.image_warenannahme = ctk.CTkImage(dark_image=Image.open("images/box_dark.png"),
                                               ...
                                               size=(30, 30))
        self.image_warenabgabe = ctk.CTkImage(dark_image=Image.open("images/abgabe_dark.png"),
                                              light_image=Image.open("images/abgabe_light.png"),
                                              size=(35, 35))
        ...
        self.navi_button_2 = ctk.CTkButton(self.navi_frame, text="Warenübergabe",
                                           text_color=("gray10", "gray90"),
                                           height=120, image=self.image_warenabgabe,
