...
class ThirdFrame(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.third_frame_inventar_button = ctk.CTkButton(self, text="Inventarisierung", height=50, corner_radius=0,
                                                      font=ctk.CTkFont(size=21, weight="bold"), fg_color="gray25",
                                                      command=self.table_2, hover_color="gray45")
        self.third_frame_mitarbeiter_button = ctk.CTkButton(self, text="Mitarbeiter", height=50, corner_radius=0,
        ...
        self.third_frame_mitarbeiter_button.grid(row=0, column=2, pady=(10, 0), padx=(1, 8), sticky="we")
    ...
    def select_table(self, table):
        ...
        self.third_frame_mitarbeiter_button.configure(text_color=("black", "white"),
